...
(
    blob="${TF_VAR_labname}-golden-components.tfstate"
    
    terraform init \
              -backend-config="key=${TF_VAR_labname}-golden-components.tfstate" \
    ...
    export TF_VAR_SAACCOUNTNAME=${STATE_SAACCOUNTNAME}
